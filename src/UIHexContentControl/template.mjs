...
:root
{
  ...
  --text-title-bg: linear-gradient(to right, white 5%, #eef5ff 40% 100%);
  --offset-title-bg: linear-gradient(to left, white 5%, #eef5ff 40% 100%);
...
[data-theme="dark"]
{
  ...
  --text-title-bg: linear-gradient(to right, rgb(23, 23, 26) 5%, #1d2027ff 40% 100%);
