...
export const ROOT_CLASS: string = representClassNames("MainFooter-ROOT_CLASS");
export const LIST_CLASS: string = representClassNames("MainFooter-LIST_CLASS");
export const VERSION_CLASS: string = representClassNames("MainFooter-VERSION_CLASS");
export const LINK_ON_CLASS: string = representClassNames("MainFooter-LINK_ON_CLASS");
export const LINK_OFF_CLASS: string = representClassNames("MainFooter-LINK_OFF_CLASS");
